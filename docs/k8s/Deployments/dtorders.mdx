...
<details>
  <summary>What's a deployment?</summary>A deployment is a set of instructions,
  usually in a YAML file like below, that provide a blueprint for what
  components we want to add to our cluster. If one of the components of that
  deployment is removed, kubernetes will automatically recreate them.
</details>
...
<details><summary>What is sed?</summary>
