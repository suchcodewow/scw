...
1 node x Standard_D2s_v4 (2x8) .08/hour

#### AWS specific notes

1 node x t3.large (2x8) 0.0832/hour

If your AWS account is not found (espiecally on a terminal with cli tools installed):
...
1 node x e2-standard-2 (2x8) .07/hour
Cluster Management fee .11/hour
