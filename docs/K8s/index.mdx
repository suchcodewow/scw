...
| Type                     | Pros & Cons                                                                                                                     |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------- |
| [Multipass](./multipass) | :white_check_mark: zero hardware/quick setup :heavy_exclamation_mark: Cluster stops when PC off/sleeping                        |
| [Build Your Own](./byoh) | :white_check_mark: Great if you have extra unused computer                                                                      |
| [Cloud](./cloud)         | :white_check_mark: Always on/Managed by cloud provider :heavy_exclamation_mark: $-$$$ depending on how big of a server you pick |
...
| Type                   | Comments                                                   |
| ---------------------- | ---------------------------------------------------------- |
| [First App](./TestApp) | An extremely simply web server to confirm everything works |
