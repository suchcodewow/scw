...
[OPTIONAL] As a DevOps Cloud admin, you can check out the resources pre-deployed for you.
...
2. Confirm that Dynatrace is connected to your Azure resources & make the following updates.
3. Open the "Apps" page.
4. Click Kubernetes (not the "new" one).
5. Check that you see a cluster running similar to "k8s[classname]".
