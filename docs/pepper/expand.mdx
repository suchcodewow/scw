...
Pepper is designed to support multiple applications. By telling where to find new yaml files, it will offer to download, configure, and install them. This is generally intended to be done in conjunction with the maintainers of Pepper, could be easily adjusted to your needs with a fork or clone.
